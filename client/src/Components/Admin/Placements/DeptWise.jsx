        ...
        <>
            ...
            <div className="container">
                ...
                </Button>
                {
                    deptData.map((data) => {
                        return (
                            <>
                                <Table striped bordered hover className='container my-3 table caption-top' responsive="lg" size="sm" key={data["_id"]}>
                                    ...
                                    <tbody>
                                        {
                                            data["departments"].map((innerData) => {
                                                return (
                                                    <>
                                                        <tr>
            ...
            <Form Form >
                ...
                <Form.Group className="mb-3 container my-3" controlId="Submit">
                    <Button onClick={addARecord} variant="primary text-center" type="submit">
                        Add Data
                    </Button>
                </Form.Group>
            </Form >
