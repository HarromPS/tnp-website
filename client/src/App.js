  ...
  return (
    <>
      ...
      <div className="App" ref={root} >
        {/* <Translate/> */}
        <AdminContext.Provider value={{ isAdminLoggedIn, setIsAdminLoggedIn, yearData, setYearData, getGraphAlldetails, graphData, setGraphData, getYearWiseAlldetails, createYearWiseRecord, editYearWiseRecord, deleteYearWiseRecord, getGraphAlldetails, createGraphRecord, editGraphRecord, deleteGraphRecord, getDeptAlldetails, createDeptRecord, editDeptRecord, deleteDeptRecord, root }}>
          <Routes>
